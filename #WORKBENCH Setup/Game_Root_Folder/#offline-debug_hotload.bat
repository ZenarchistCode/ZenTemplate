...
start /D "GAMEDIRECTORYDayZ" DayZDiag_x64.exe "-mod=P:\%modname%;P:\@Dependencies\@CF;P:\@Dependencies\@VPPAdminTools;" -filePatching "-mission=./mpmissions/singlePlayer.ChernarusPlus"