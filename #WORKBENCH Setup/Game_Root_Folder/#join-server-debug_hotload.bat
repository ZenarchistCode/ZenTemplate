...
start /D "GAMEDIRECTORYDayZ" DayZDiag_x64.exe "-profiles=profiles" "-mod=P:\%modname%;P:\@Dependencies\@CF;P:\@Dependencies\@VPPAdminTools;" "-mission=./mpmissions/firstMission.ChernarusPlus" -filePatching -connect=127.0.0.1 -port=2302